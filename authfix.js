(function(){
  function style(){
    ...
    s.textContent=`
      ...
      .auth-mark{font-size:31px;font-weight:950;letter-spacing:-1.8px;color:#0b1424}.auth-mark::first-letter{color:#0b1424}
      ...
      .auth input{height:50px;width:100%;padding:0 14px;margin:0 0 18px;border:1px solid #d0d5dd;border-radius:11px;background:#fff;color:#101828;outline:none;box-sizing:border-box;transition:.18s;font-size:14px}
      ...
      .cvgo-lead{font-size:17px;line-height:1.58;color:#52627a;max-width:530px;margin:0 0 28px}
      .cvgo-features{display:grid;gap:17px;margin:0 0 30px;max-width:510px}
      ...
      .cvgo-trial{display:flex;gap:13px;align-items:center;max-width:510px;padding:15px 17px;border:1px solid #cdeee0;background:rgba(240,253,245,.78);border-radius:14px}
      ...
      @media(max-width:600px){body:has(#auth:not(.hidden)) header{padding:0 20px}.auth{min-height:auto;margin:0 auto;padding:28px 15px 40px}.cvgo-marketing h2{font-size:35px;letter-spacing:-1.5px}.cvgo-lead{font-size:15px}.cvgo-features{gap:13px}.auth .card{padding:32px 24px 28px}.auth h1{font-size:28px}}
    `;
  ...
  function addMarketing(){
    ...
    panel.innerHTML=`<div class="cvgo-eyebrow">CONSTRUYE TU FUTURO PROFESIONAL</div>
      ...
      <div class="cvgo-trial"><div class="cvgo-trial-icon">🎁</div><div><strong>7 días gratis · Sin compromiso</strong><span>Explora todas las funciones y empieza hoy.</span></div></div>`;
    auth.prepend(panel);
  }
