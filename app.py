...
def home():
    ...
    html=html.replace('</body>','<script src="/ai.js?v=4"></script><script src="/cvpersist.js?v=4"></script><script src="/profix.js?v=3"></script><script src="/cvimport.js?v=4"></script><link id="cvgoDashboardCss" rel="stylesheet" href="/dashboard.css?v=6"><script id="cvgoDashboardScript" src="/dashboard.js?v=13"></script></body>')
