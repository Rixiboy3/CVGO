(function(){
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.id='cvpCommercialStyles';s.textContent=`
      ...
      #cvpNextAction{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:13px;padding:12px 14px;border-radius:12px;background:#111827;color:#fff}.cvpNextActionText b{display:block;font-size:12px}.cvpNextActionText span{display:block;font-size:10px;color:#d1d5db;margin-top:3px}
      #cvpNextAction button,#cvpNextAction button[data-cvp-next],#cvpNextAction button[data-cvp-new]{appearance:none!important;-webkit-appearance:none!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:6px!important;box-sizing:border-box!important;min-width:112px!important;min-height:40px!important;margin:0!important;border:1px solid #2563eb!important;border-radius:10px!important;background:linear-gradient(135deg,#2563eb,#1747c8)!important;color:#fff!important;padding:9px 16px!important;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;font-size:12px!important;font-weight:800!important;line-height:1.2!important;cursor:pointer!important;white-space:nowrap!important;box-shadow:0 7px 18px rgba(37,99,235,.22)!important;transition:transform .18s ease,box-shadow .18s ease,filter .18s ease!important}
      #cvpNextAction button:hover,#cvpNextAction button[data-cvp-next]:hover,#cvpNextAction button[data-cvp-new]:hover{transform:translateY(-1px)!important;box-shadow:0 10px 22px rgba(37,99,235,.30)!important;filter:brightness(1.04)!important}
      #cvpNextAction button:active,#cvpNextAction button[data-cvp-next]:active,#cvpNextAction button[data-cvp-new]:active{transform:translateY(0)!important}
      #cvpNextAction button:focus-visible,#cvpNextAction button[data-cvp-next]:focus-visible,#cvpNextAction button[data-cvp-new]:focus-visible{outline:3px solid rgba(96,165,250,.45)!important;outline-offset:2px!important}
